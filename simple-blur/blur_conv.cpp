...
static ModelError_t addTensor_input(QnnModel& model){
  ...
  uint32_t dimensions_input[] = {1, 288, 384, 3};
...
static ModelError_t addTensor__Constant_output_0(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions__Constant_output_0[] = {9, 9, 1, 3};
...
static ModelError_t addTensor__Conv_bias(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions__Conv_bias[] = {3};
  VALIDATE(model.addTensor("_Conv_bias", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
                                 .rank= 1,
                                 .dimensions=dimensions__Conv_bias,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(_Conv_bias),
                                                .dataSize=BINLEN(_Conv_bias)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Conv(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Conv */
  uint32_t dimensions___Conv_dilation[] = {2};
  uint32_t __Conv_dilation[] = {1, 1};
  uint32_t dimensions___Conv_pad_amount[] = {2, 2};
  uint32_t __Conv_pad_amount[] = {4, 4, 4, 4};
  uint32_t dimensions___Conv_stride[] = {2};
  uint32_t __Conv_stride[] = {1, 1};
  Qnn_Param_t params__Conv[] = {
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions___Conv_dilation,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__Conv_dilation,
                           .dataSize=8}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___Conv_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__Conv_pad_amount,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions___Conv_stride,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__Conv_stride,
                           .dataSize=8}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__Conv[] = {
    "input",
    "_Constant_output_0",
    "_Conv_bias"
  };
  uint32_t dimensions_output[] = {1, 288, 384, 3};
  Qnn_Tensor_t outputs__Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         params__Conv, // Node Params
                         3, // Num Node Params
                         inputs__Conv, // Input Tensor Names
                         3, // Num Input Tensor Names
                         outputs__Conv, // Output Tensors 
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for blur_conv*/
  QnnModel blur_conv;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("blur_conv", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(blur_conv.initialize(backendHandle, interface, contextHandle, "blur_conv", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input(blur_conv), err);
  VALIDATE(addTensor__Constant_output_0(blur_conv), err);
  VALIDATE(addTensor__Conv_bias(blur_conv), err);
  VALIDATE(addNode__Conv(blur_conv), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&blur_conv};
